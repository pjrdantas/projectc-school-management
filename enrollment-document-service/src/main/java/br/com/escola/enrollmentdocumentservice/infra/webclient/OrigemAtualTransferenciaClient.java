...
@Component
public class OrigemAtualTransferenciaClient implements EnrollmentTransferPort {

    private final RestClient restClient;
    private final MeterRegistry meterRegistry;

    public OrigemAtualTransferenciaClient(
    ...
    public EscolaOrigemResponse buscarEscolaOrigem(String authorization, InternalRequestContext context, UUID id) {
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new RecursoNaoEncontradoException("Escola de origem nao encontrada");
            }
    ...
    public TransferenciaAlunoResponse buscarTransferencia(String authorization, InternalRequestContext context, UUID id) {
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new RecursoNaoEncontradoException("Transferencia nao encontrada");
            }
    ...
    public DocumentoAlunoResponse buscarDocumentoAlunoPorId(
        ...
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new RecursoNaoEncontradoException("Documento do aluno nao encontrado");
            }
