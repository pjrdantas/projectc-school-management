package br.com.escola.enrollmentdocumentservice.infra.security;
...
public class InternalApiInterceptor implements HandlerInterceptor {
    ...
    public InternalApiInterceptor(@Value("${enrollment-document.internal-api.token:}") String configuredToken) {
