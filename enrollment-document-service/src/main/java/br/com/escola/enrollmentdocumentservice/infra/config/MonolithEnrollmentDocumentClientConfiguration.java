...
@Configuration
public class MonolithEnrollmentDocumentClientConfiguration {

    @Bean
    RestClient monolithEnrollmentDocumentRestClient(MonolithEnrollmentDocumentClientProperties properties) {
