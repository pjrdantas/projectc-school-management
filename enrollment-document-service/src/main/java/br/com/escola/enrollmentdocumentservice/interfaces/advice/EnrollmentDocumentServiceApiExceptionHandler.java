...
public class EnrollmentDocumentServiceApiExceptionHandler {

    @ExceptionHandler(EnrollmentDocumentServiceResourceNotFoundException.class)
    ResponseEntity<ApiErrorResponse> handleNotFound(
            EnrollmentDocumentServiceResourceNotFoundException exception,
