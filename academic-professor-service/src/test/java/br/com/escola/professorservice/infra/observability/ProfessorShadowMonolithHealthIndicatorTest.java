...
class ProfessorShadowMonolithHealthIndicatorTest {
    ...
    void deveReportarUpComDiagnosticoDetalhadoPorRota() {
        ...
        ProfessorShadowMonolithHealthIndicator indicator = new ProfessorShadowMonolithHealthIndicator(
                new MonolithProfessorClientProperties(
