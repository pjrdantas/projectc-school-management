...
public class ProfessorServiceApiExceptionHandler {

    @ExceptionHandler(ProfessorServiceResourceNotFoundException.class)
    ResponseEntity<ApiErrorResponse> handleNotFound(
            ProfessorServiceResourceNotFoundException exception,
