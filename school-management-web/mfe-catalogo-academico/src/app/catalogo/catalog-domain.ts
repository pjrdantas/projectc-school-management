...
export { AcademicClassesComponent } from './pages/classes/academic-classes.component';
export { DisciplinesComponent } from '../historico/pages/disciplines/disciplines.component';
