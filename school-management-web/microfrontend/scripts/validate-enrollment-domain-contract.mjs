...
if (errors.length > 0) {
  console.error('Contrato interno do dominio matriculas invalido:');
...
console.log(
  `Contrato interno de matriculas valido: ${manifestItems.length} entrada conferida entre manifesto, exposes, federation.config.js e shell do host.`,
);
