import { DiarioClasseResponse, FrequenciaStatus } from './diario-classe-api.models';
...
export const DIARIO_CLASSE_MOCK: DiarioClasseResponse = {
  cabecalho: {
    idDiarioClasse: `diario-${anoMock}-${mesMockComZero}-8a-matematica`, idEscola: 'esc-001', escola: 'EMEF Professora Helena Duarte',
    diretoriaEnsino: 'Centro-Oeste', municipio: 'São Paulo', anoLetivo: anoMock, mes: mesMock, dataAtual: dataAtualMock,
    idTurma: 'turma-8a-2026', turmaSerie: '8º A', turno: 'Manhã', idDisciplina: 'disc-matematica', disciplina: 'Matemática', idProfessor: 'prof-001', professor: 'Marina Albuquerque'
  },
  alunos: [
