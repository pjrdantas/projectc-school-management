package br.com.escola.institutionaltenantservice.infra.security;
...
public class InternalApiInterceptor implements HandlerInterceptor {
    ...
    public InternalApiInterceptor(@Value("${institutional-tenant.internal-api.token:}") String configuredToken) {
