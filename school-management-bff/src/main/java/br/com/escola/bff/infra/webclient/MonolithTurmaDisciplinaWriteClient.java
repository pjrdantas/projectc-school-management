...
@Component
public class MonolithTurmaDisciplinaWriteClient implements MonolithTurmaDisciplinaWritePort {

    private final WebClient webClient;
    private final CircuitBreaker circuitBreaker;
    private final MonolithClientProperties properties;

    public MonolithTurmaDisciplinaWriteClient(
    ...
    @Override
    public Mono<TurmaDisciplinaLinkedResult> vincular(CatalogWriteQuery query, TurmaDisciplinaLinkCommand command) {
        return webClient.post()
                .uri("/api/turmas/{turmaId}/disciplinas", command.turmaId())
                .header("Authorization", query.authorization())
                .header(TrustedHeaders.CORRELATION_ID, query.correlationId())
                .bodyValue(new MonolithLinkTurmaDisciplinaRequest(command.disciplinaId(), command.cargaHoraria()))
                .retrieve()
                .onStatus(
                ...
                .bodyToMono(TurmaDisciplinaLinkedResult.class)
    ...
    private record MonolithLinkTurmaDisciplinaRequest(
