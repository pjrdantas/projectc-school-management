...
@Component
public class LegacyPainelFrontendReadClient extends AbstractDownstreamClientSupport
        implements LegacyPainelFrontendReadPort {

    private final WebClient webClient;

    public LegacyPainelFrontendReadClient(@Qualifier("monolithWebClient") WebClient webClient) {
