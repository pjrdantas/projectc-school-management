...
@Component
public class PlanningAiConteudoDetailReadClient extends AbstractDownstreamClientSupport
        implements PlanningAiConteudoDetailReadPort {

    private final WebClient webClient;
    private final PlanningAiServiceClientProperties properties;

    public PlanningAiConteudoDetailReadClient(
