...
@Component
public class PlanejamentoIaConteudoDetalheReadClient extends AbstractDownstreamClientSupport
        implements PlanejamentoIaConteudoDetalheReadPort {

    private final WebClient webClient;
    private final PlanejamentoIaServiceClientProperties properties;

    public PlanejamentoIaConteudoDetalheReadClient(
    ...
    @Override
    public Mono<org.springframework.http.ResponseEntity<String>> buscarConteudo(
            UUID conteudoId,
            CatalogReadQuery query,
            AuthSessionContext context) {
        String uri = "/internal/v1/ia/conteudos/" + conteudoId;
