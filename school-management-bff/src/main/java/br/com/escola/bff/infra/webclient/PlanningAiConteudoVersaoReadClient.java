...
@Component
public class PlanningAiConteudoVersaoReadClient extends AbstractDownstreamClientSupport
        implements PlanningAiConteudoVersaoReadPort {

    private final WebClient webClient;
    private final PlanningAiServiceClientProperties properties;

    public PlanningAiConteudoVersaoReadClient(
