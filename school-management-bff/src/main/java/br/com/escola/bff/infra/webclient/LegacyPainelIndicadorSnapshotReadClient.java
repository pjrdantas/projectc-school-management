...
@Component
public class LegacyPainelIndicadorSnapshotReadClient extends AbstractDownstreamClientSupport
        implements LegacyPainelIndicadorSnapshotReadPort {

    private final WebClient webClient;

    public LegacyPainelIndicadorSnapshotReadClient(
