...
@Component
public class PedagogicalHistoricoEscolarReadClient extends AbstractDownstreamClientSupport
        implements PedagogicalHistoricoEscolarReadPort {

    private final WebClient webClient;
    private final PedagogicalServiceClientProperties properties;

    public PedagogicalHistoricoEscolarReadClient(
