...
public class DashboardProfessorReadController {

    private final ConsultarDashboardProfessorUseCase consultarDashboardProfessorUseCase;

    public DashboardProfessorReadController(ConsultarDashboardProfessorUseCase consultarDashboardProfessorUseCase) {
        this.consultarDashboardProfessorUseCase = consultarDashboardProfessorUseCase;
    }
    ...
    public Mono<ResponseEntity<String>> consultar(
        ...
        return consultarDashboardProfessorUseCase.consultar(authorization, correlationId, professorId);
    }
}
