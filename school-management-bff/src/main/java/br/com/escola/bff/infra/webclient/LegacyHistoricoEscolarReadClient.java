...
@Component
public class LegacyHistoricoEscolarReadClient extends AbstractDownstreamClientSupport
        implements LegacyHistoricoEscolarReadPort {

    private final WebClient webClient;

    public LegacyHistoricoEscolarReadClient(
