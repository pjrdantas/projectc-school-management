...
@Component
public class AcademicCatalogSerieWriteClient extends AbstractDownstreamClientSupport
        implements AcademicCatalogSerieWritePort {

    private final WebClient webClient;
    private final CatalogServiceClientProperties properties;

    public AcademicCatalogSerieWriteClient(
