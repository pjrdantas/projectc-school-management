...
@Component
public class EnrollmentDocumentReadClient extends AbstractDownstreamClientSupport
        implements EnrollmentDocumentReadPort {

    private final WebClient webClient;
    private final EnrollmentDocumentServiceClientProperties properties;

    public EnrollmentDocumentReadClient(
