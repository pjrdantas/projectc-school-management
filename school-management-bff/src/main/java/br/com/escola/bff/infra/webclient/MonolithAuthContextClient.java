...
@Component
public class MonolithAuthContextClient implements AuthContextPort {

    private final WebClient webClient;
    private final CircuitBreaker circuitBreaker;
    private final MonolithClientProperties properties;

    public MonolithAuthContextClient(
    ...
    public Mono<AuthSessionContext> resolve(CatalogReadQuery query) {
        return webClient.get()
                ...
                .map(response -> new AuthSessionContext(response.usuarioId(), response.escolaId()))
