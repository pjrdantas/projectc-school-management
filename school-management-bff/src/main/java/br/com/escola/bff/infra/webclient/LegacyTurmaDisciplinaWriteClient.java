...
@Component
public class LegacyTurmaDisciplinaWriteClient implements LegacyTurmaDisciplinaWritePort {

    private final WebClient webClient;
    private final CircuitBreaker circuitBreaker;
    private final LegacyClientProperties properties;

    public LegacyTurmaDisciplinaWriteClient(
    ...
    public Mono<TurmaDisciplinaLinkedResult> vincular(CatalogWriteQuery query, TurmaDisciplinaLinkCommand command) {
        return webClient.post()
                ...
                .bodyValue(new LegacyLinkTurmaDisciplinaRequest(command.disciplinaId(), command.cargaHoraria()))
                .retrieve()
                .onStatus(
    ...
    private record LegacyLinkTurmaDisciplinaRequest(
