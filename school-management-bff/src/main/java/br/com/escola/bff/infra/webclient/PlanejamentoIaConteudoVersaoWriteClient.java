...
@Component
public class PlanejamentoIaConteudoVersaoWriteClient extends AbstractDownstreamClientSupport
        implements PlanejamentoIaConteudoVersaoWritePort {

    private final WebClient webClient;
    private final PlanejamentoIaServiceClientProperties properties;

    public PlanejamentoIaConteudoVersaoWriteClient(
