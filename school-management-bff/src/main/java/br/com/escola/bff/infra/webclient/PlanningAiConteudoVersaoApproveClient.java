...
@Component
public class PlanningAiConteudoVersaoApproveClient extends AbstractDownstreamClientSupport
        implements PlanningAiConteudoVersaoApprovePort {

    private final WebClient webClient;
    private final PlanningAiServiceClientProperties properties;

    public PlanningAiConteudoVersaoApproveClient(
