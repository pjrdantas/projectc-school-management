...
@Component
public class AcademicCatalogNivelEnsinoResolverClient extends AbstractDownstreamClientSupport
        implements AcademicCatalogNivelEnsinoResolverPort {

    private final WebClient webClient;
    private final CatalogServiceClientProperties properties;

    public AcademicCatalogNivelEnsinoResolverClient(
