...
public class PainelIndicadorHistoricoReadController {

    private final ConsultarPainelIndicadorHistoricoUseCase consultarPainelIndicadorHistoricoUseCase;

    public PainelIndicadorHistoricoReadController(
            ConsultarPainelIndicadorHistoricoUseCase consultarPainelIndicadorHistoricoUseCase) {
        this.consultarPainelIndicadorHistoricoUseCase = consultarPainelIndicadorHistoricoUseCase;
    }
    ...
    public Mono<ResponseEntity<String>> consultarHistorico(
        ...
        return consultarPainelIndicadorHistoricoUseCase.consultarHistorico(
                authorization,
                correlationId,
                publicoCodigo,
                codigoIndicador,
