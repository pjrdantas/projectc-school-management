...
@Component
public class DashboardAcademicoReadClient extends AbstractDownstreamClientSupport implements DashboardAcademicoReadPort {

    private final WebClient webClient;
    private final DashboardQueryServiceClientProperties properties;

    public DashboardAcademicoReadClient(
    ...
    public Mono<org.springframework.http.ResponseEntity<String>> consultar(
        ...
        return webClient.get()
                .uri("/internal/v1/dashboard/academico")
