...
@Component
public class MonolithResponsavelReadClient extends AbstractDownstreamClientSupport implements MonolithResponsavelReadPort {

    private final WebClient webClient;

    public MonolithResponsavelReadClient(
