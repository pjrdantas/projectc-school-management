...
@Component
public class AcademicCatalogDisciplinaWriteClient extends AbstractDownstreamClientSupport
        implements AcademicCatalogDisciplinaWritePort {

    private final WebClient webClient;
    private final CatalogServiceClientProperties properties;

    public AcademicCatalogDisciplinaWriteClient(
