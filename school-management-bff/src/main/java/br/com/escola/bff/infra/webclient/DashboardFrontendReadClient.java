...
@Component
public class DashboardFrontendReadClient extends AbstractDownstreamClientSupport implements DashboardFrontendReadPort {

    private final WebClient webClient;
    private final DashboardQueryServiceClientProperties properties;

    public DashboardFrontendReadClient(
