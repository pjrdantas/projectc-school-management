...
@Component
public class AcademicCatalogPeriodoLetivoWriteClient extends AbstractDownstreamClientSupport
        implements AcademicCatalogPeriodoLetivoWritePort {

    private final WebClient webClient;
    private final CatalogServiceClientProperties properties;

    public AcademicCatalogPeriodoLetivoWriteClient(
