...
public class MonolithClientConfiguration {
    ...
    @Bean
    WebClient peopleServiceWebClient(PeopleServiceClientProperties properties) {
        HttpClient httpClient = HttpClient.create()
                .option(
                        io.netty.channel.ChannelOption.CONNECT_TIMEOUT_MILLIS,
                        Math.toIntExact(properties.connectTimeout().toMillis()))
    ...
    @Bean
    WebClient responsiblesServiceWebClient(ResponsiblesServiceClientProperties properties) {
        HttpClient httpClient = HttpClient.create()
                .option(
                        io.netty.channel.ChannelOption.CONNECT_TIMEOUT_MILLIS,
                        Math.toIntExact(properties.connectTimeout().toMillis()))
    ...
    @Bean
    WebClient institutionalTenantServiceWebClient(InstitutionalTenantServiceClientProperties properties) {
        HttpClient httpClient = HttpClient.create()
                .option(
                        io.netty.channel.ChannelOption.CONNECT_TIMEOUT_MILLIS,
                        Math.toIntExact(properties.connectTimeout().toMillis()))
    ...
    @Bean
    WebClient dashboardQueryServiceWebClient(DashboardQueryServiceClientProperties properties) {
        HttpClient httpClient = HttpClient.create()
                .option(
                        io.netty.channel.ChannelOption.CONNECT_TIMEOUT_MILLIS,
                        Math.toIntExact(properties.connectTimeout().toMillis()))
    ...
    @Bean
    WebClient pedagogicalServiceWebClient(PedagogicalServiceClientProperties properties) {
        HttpClient httpClient = HttpClient.create()
                .option(
                        io.netty.channel.ChannelOption.CONNECT_TIMEOUT_MILLIS,
                        Math.toIntExact(properties.connectTimeout().toMillis()))
    ...
    @Bean
    WebClient planningAiServiceWebClient(PlanningAiServiceClientProperties properties) {
        HttpClient httpClient = HttpClient.create()
                .option(
                        io.netty.channel.ChannelOption.CONNECT_TIMEOUT_MILLIS,
                        Math.toIntExact(properties.connectTimeout().toMillis()))
