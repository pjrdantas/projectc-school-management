...
@Component
public class EnrollmentDocumentEscolaOrigemReadClient extends AbstractDownstreamClientSupport
        implements EnrollmentDocumentEscolaOrigemReadPort {

    private final WebClient webClient;
    private final EnrollmentDocumentServiceClientProperties properties;

    public EnrollmentDocumentEscolaOrigemReadClient(
