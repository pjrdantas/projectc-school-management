...
@Component
public class EscolaOrigemMatriculaWriteClient extends AbstractDownstreamClientSupport
        implements EscolaOrigemMatriculaWritePort {

    private final WebClient webClient;
    private final DocumentoMatriculaServiceClientProperties properties;

    public EscolaOrigemMatriculaWriteClient(
