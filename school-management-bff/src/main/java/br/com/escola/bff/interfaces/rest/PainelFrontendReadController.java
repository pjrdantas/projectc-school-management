...
public class PainelFrontendReadController {

    private final ConsultarPainelFrontendUseCase consultarPainelFrontendUseCase;

    public PainelFrontendReadController(ConsultarPainelFrontendUseCase consultarPainelFrontendUseCase) {
        this.consultarPainelFrontendUseCase = consultarPainelFrontendUseCase;
    }
    ...
    public Mono<ResponseEntity<String>> consultar(
        ...
        return consultarPainelFrontendUseCase.consultar(
                authorization,
                correlationId,
                publicoCodigo,
                usuarioId,
