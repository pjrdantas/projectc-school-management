...
@Component
public class MonolithDiarioClasseReadClient extends AbstractDownstreamClientSupport
        implements MonolithDiarioClasseReadPort {

    private final WebClient webClient;

    public MonolithDiarioClasseReadClient(
