...
@Component
public class PedagogicalHistoricoEscolarWriteClient extends AbstractDownstreamClientSupport
        implements PedagogicalHistoricoEscolarWritePort {

    private final WebClient webClient;
    private final PedagogicalServiceClientProperties properties;

    public PedagogicalHistoricoEscolarWriteClient(
