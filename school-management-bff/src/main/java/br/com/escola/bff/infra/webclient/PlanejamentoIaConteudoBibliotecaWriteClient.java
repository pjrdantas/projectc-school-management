...
@Component
public class PlanejamentoIaConteudoBibliotecaWriteClient extends AbstractDownstreamClientSupport
        implements PlanejamentoIaConteudoBibliotecaWritePort {

    private final WebClient webClient;
    private final PlanejamentoIaServiceClientProperties properties;

    public PlanejamentoIaConteudoBibliotecaWriteClient(
