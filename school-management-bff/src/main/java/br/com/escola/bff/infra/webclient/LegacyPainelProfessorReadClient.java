...
@Component
public class LegacyPainelProfessorReadClient extends AbstractDownstreamClientSupport implements LegacyPainelProfessorReadPort {

    private final WebClient webClient;

    public LegacyPainelProfessorReadClient(
