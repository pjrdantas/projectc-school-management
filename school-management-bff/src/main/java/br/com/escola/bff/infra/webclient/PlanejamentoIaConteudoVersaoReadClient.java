...
@Component
public class PlanejamentoIaConteudoVersaoReadClient extends AbstractDownstreamClientSupport
        implements PlanejamentoIaConteudoVersaoReadPort {

    private final WebClient webClient;
    private final PlanejamentoIaServiceClientProperties properties;

    public PlanejamentoIaConteudoVersaoReadClient(
    ...
    @Override
    public Mono<org.springframework.http.ResponseEntity<String>> listarVersoes(
            UUID conteudoId,
