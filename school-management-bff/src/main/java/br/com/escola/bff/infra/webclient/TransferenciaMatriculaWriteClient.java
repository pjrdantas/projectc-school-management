...
@Component
public class TransferenciaMatriculaWriteClient extends AbstractDownstreamClientSupport
        implements TransferenciaMatriculaWritePort {

    private final WebClient webClient;
    private final DocumentoMatriculaServiceClientProperties properties;

    public TransferenciaMatriculaWriteClient(
