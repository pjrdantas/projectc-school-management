...
@Component
public class MonolithDashboardDiretorReadClient extends AbstractDownstreamClientSupport implements MonolithDashboardDiretorReadPort {

    private final WebClient webClient;

    public MonolithDashboardDiretorReadClient(
