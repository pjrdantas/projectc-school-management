...
@Component
public class CatalogoTurnoResolverClient extends AbstractDownstreamClientSupport
        implements CatalogoTurnoResolverPort {

    private final WebClient webClient;
    private final CatalogServiceClientProperties properties;

    public CatalogoTurnoResolverClient(
