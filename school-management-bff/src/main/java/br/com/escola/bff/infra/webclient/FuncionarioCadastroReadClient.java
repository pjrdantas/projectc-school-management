...
@Component
public class FuncionarioCadastroReadClient extends AbstractDownstreamClientSupport implements FuncionarioCadastroReadPort {

    private final WebClient webClient;
    private final CadastroPessoaClientProperties properties;

    public FuncionarioCadastroReadClient(
