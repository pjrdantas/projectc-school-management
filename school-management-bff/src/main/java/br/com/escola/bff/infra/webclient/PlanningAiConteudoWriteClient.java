...
@Component
public class PlanningAiConteudoWriteClient extends AbstractDownstreamClientSupport
        implements PlanningAiConteudoWritePort {

    private final WebClient webClient;
    private final PlanningAiServiceClientProperties properties;

    public PlanningAiConteudoWriteClient(
