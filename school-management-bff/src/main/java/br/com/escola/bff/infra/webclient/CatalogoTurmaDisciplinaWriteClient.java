...
@Component
public class CatalogoTurmaDisciplinaWriteClient extends AbstractDownstreamClientSupport
        implements CatalogoTurmaDisciplinaWritePort {

    private final WebClient webClient;
    private final CatalogServiceClientProperties properties;

    public CatalogoTurmaDisciplinaWriteClient(
