...
@Component
public class MonolithDashboardIndicadorHistoricoReadClient extends AbstractDownstreamClientSupport
        implements MonolithDashboardIndicadorHistoricoReadPort {

    private final WebClient webClient;

    public MonolithDashboardIndicadorHistoricoReadClient(
