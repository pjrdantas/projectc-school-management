...
@Component
public class LegacyPainelAlertaReadClient extends AbstractDownstreamClientSupport implements LegacyPainelAlertaReadPort {

    private final WebClient webClient;

    public LegacyPainelAlertaReadClient(
