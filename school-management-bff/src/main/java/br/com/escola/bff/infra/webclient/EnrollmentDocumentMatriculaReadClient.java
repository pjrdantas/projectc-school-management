...
@Component
public class EnrollmentDocumentMatriculaReadClient extends AbstractDownstreamClientSupport
        implements EnrollmentDocumentMatriculaReadPort {

    private final WebClient webClient;
    private final EnrollmentDocumentServiceClientProperties properties;

    public EnrollmentDocumentMatriculaReadClient(
