...
class EnrollmentDocumentWriteProxyIntegrationTest {
    ...
    @Test
    void deveConsumirEnrollmentDocumentServiceNaCriacaoDeEscolaOrigem() throws InterruptedException {
    ...
    @Test
    void deveConsumirEnrollmentDocumentServiceNaCriacaoDeTransferencia() throws InterruptedException {
        MONOLITH.enqueue(new MockResponse()
                .setHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .setBody("""
                        {
