...
class PlanningAiConteudoVersaoWriteProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanningAiServiceNaCriacaoOficialDeVersaoConteudoIa() throws InterruptedException {
