...
class PlanejamentoIaConteudoVersaoReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanejamentoIaServiceNaListagemOficialDeVersoesConteudoIa() throws InterruptedException {
