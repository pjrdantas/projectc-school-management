...
class DashboardConfiguracaoReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirDashboardQueryServiceNaLeituraOficialDeDashboardsConfigurados() throws InterruptedException {
        ...
        DASHBOARD_QUERY.enqueue(new MockResponse()
                .setHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .setHeader(TrustedHeaders.CORRELATION_ID, "corr-dashboard-config-1")
                .setBody("""
                        [{
                          "id":"00000000-0000-0000-0000-000000000701",
                          "publicoDashboardId":"00000000-0000-0000-0000-000000000601",
                          "publicoCodigo":"DASH-CONF-DIRETOR",
                          "codigo":"DASH-CONF-DIRETOR-GERAL",
                          "nome":"Dashboard Diretor Teste",
                          "descricao":"Dashboard criado para teste",
                          "ativo":true
                        }]
                        """));
        ...
        client.get().uri(uriBuilder -> uriBuilder.path("/api/dashboard/configuracoes/dashboards")
                ...
                .exchange()
                .expectStatus().isOk()
                .expectHeader().valueEquals(TrustedHeaders.CORRELATION_ID, "corr-dashboard-config-1")
                .expectBody()
                .jsonPath("$[0].codigo").isEqualTo("DASH-CONF-DIRETOR-GERAL")
                .jsonPath("$[0].nome").isEqualTo("Dashboard Diretor Teste");
    ...
    @Test
    void deveFazerFallbackParaMonolitoQuandoDashboardQueryServiceEstiverIndisponivel() throws InterruptedException {
        IDENTITY_ACCESS.enqueue(new MockResponse()
                .setHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .setBody("""
                        {
        ...
        MONOLITH.enqueue(new MockResponse()
                ...
                .setBody("""
                        [{
                          ...
                          "publicoDashboardId":"00000000-0000-0000-0000-000000000602",
                          "publicoCodigo":"DASH-CONF-SECRETARIA",
                          "codigo":"DASH-CONF-SECRETARIA-OPERACIONAL",
                          "nome":"Dashboard Secretaria",
        ...
        MONOLITH.enqueue(new MockResponse()
                ...
                .setBody("""
                        [{
                          ...
                          "publicoDashboardId":"00000000-0000-0000-0000-000000000603",
                          "publicoCodigo":"DASH-CONF-PROFESSOR",
                          "codigo":"DASH-CONF-PROFESSOR-OPERACIONAL",
                          "nome":"Dashboard Professor",
