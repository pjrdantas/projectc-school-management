...
class PlanejamentoIaConteudoReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanejamentoIaServiceNaListagemOficialDeConteudosPlanejamentoIa() throws InterruptedException {
