...
class PlanejamentoIaInteracaoReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanejamentoIaServiceNaListagemOficialDeInteracoesPlanejamentoIa() throws InterruptedException {
        ...
        client.get().uri("/api/planejamentos-bimestrais/{planejamentoId}/ia/interacoes", planejamentoId)
                ...
                .header(TrustedHeaders.CORRELATION_ID, "corr-planejamento-ia-2")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        assertThat(planningRequest.getHeader("X-Correlation-Id")).isEqualTo("corr-planejamento-ia-2");
