...
class PlanningAiConteudoBibliotecaWriteProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanningAiServiceNaPublicacaoOficialDeConteudoIaNaBiblioteca() throws InterruptedException {
