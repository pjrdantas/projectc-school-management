...
class DashboardIndicadorHistoricoReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirDashboardQueryServiceNaLeituraOficialDeHistorico() throws InterruptedException {
