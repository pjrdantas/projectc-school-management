...
class PlanejamentoIaBibliotecaReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanejamentoIaServiceNaListagemOficialDaBibliotecaPedagogica() throws InterruptedException {
