...
class PlanejamentoIaConteudoDetalheReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanejamentoIaServiceNaBuscaOficialDeConteudoPlanejamentoIa() throws InterruptedException {
        String conteudoId = "00000000-0000-0000-0000-000000000911";
        ...
        client.get().uri("/api/ia/conteudos/{conteudoId}", conteudoId)
                ...
                .header(TrustedHeaders.CORRELATION_ID, "corr-planejamento-conteudo-detail-2")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.id").isEqualTo(conteudoId)
        ...
        assertThat(planningRequest.getPath())
                .isEqualTo("/internal/v1/ia/conteudos/" + conteudoId);
        ...
        assertThat(planningRequest.getHeader("X-Correlation-Id")).isEqualTo("corr-planejamento-conteudo-detail-2");
