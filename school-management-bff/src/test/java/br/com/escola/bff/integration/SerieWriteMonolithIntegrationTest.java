...
class SerieWriteMonolithIntegrationTest {
    ...
    @Test
    void deveVoltarParaMonolitoQuandoCutoverDeEscritaDeSerieEstiverDesabilitado() throws Exception {
        MONOLITH.enqueue(json("""
                {
                  ...
                  "createdAt":"2026-06-23T11:12:00"
                }
                """, 201));

        client.post().uri("/api/series")
                .header(HttpHeaders.AUTHORIZATION, "Bearer opaque-token")
                .header(TrustedHeaders.CORRELATION_ID, "corr-serie-disabled")
