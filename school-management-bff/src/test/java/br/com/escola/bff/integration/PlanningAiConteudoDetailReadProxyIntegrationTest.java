...
class PlanningAiConteudoDetailReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanningAiServiceNaBuscaOficialDeConteudoPlanejamentoIa() throws InterruptedException {
