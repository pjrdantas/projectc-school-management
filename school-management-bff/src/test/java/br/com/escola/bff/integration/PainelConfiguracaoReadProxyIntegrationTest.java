...
class PainelConfiguracaoReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPainelQueryServiceNaLeituraOficialDePainelsConfigurados() throws InterruptedException {
        ...
        client.get().uri("/api/dashboard/configuracoes/dashboards")
                ...
                .jsonPath("$[0].nome").isEqualTo("Painel Diretor Teste");
