...
class DashboardPublicoReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirDashboardQueryServiceNaLeituraOficialDePublicos() throws InterruptedException {
        ...
        DASHBOARD_QUERY.enqueue(new MockResponse()
                .setHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE)
                .setHeader(TrustedHeaders.CORRELATION_ID, "corr-dashboard-publico-1")
                .setBody("""
                        [{
        ...
        client.get().uri("/api/dashboard/configuracoes/publicos")
                ...
                .header(TrustedHeaders.CORRELATION_ID, "corr-dashboard-publico-1")
                .exchange()
                .expectStatus().isOk()
                .expectHeader().valueEquals(TrustedHeaders.CORRELATION_ID, "corr-dashboard-publico-1")
                .expectBody()
                .jsonPath("$[0].codigo").isEqualTo("DASH-CONF-DIRETOR")
                .jsonPath("$[0].descricao").isEqualTo("Diretoria teste");
        ...
        assertThat(dashboardRequest.getPath()).isEqualTo("/internal/v1/dashboard/configuracoes/publicos");
        ...
        if (monolithRequest != null) {
            assertThat(monolithRequest.getPath()).isNotEqualTo("/api/dashboard/configuracoes/publicos");
        }
    }
