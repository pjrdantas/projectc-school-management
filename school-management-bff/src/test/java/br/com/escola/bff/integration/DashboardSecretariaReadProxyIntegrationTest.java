...
class DashboardSecretariaReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirDashboardQueryServiceNaLeituraOficialDoDashboardSecretaria() throws InterruptedException {
