...
class PlanejamentoIaConteudoBibliotecaWriteProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanejamentoIaServiceNaPublicacaoOficialDeConteudoIaNaBiblioteca() throws InterruptedException {
        ...
        client.post().uri("/api/ia/conteudos/{conteudoId}/publicar-biblioteca", conteudoId)
                ...
                .header(TrustedHeaders.CORRELATION_ID, "corr-planejamento-biblioteca-write-2")
                .exchange()
        ...
        assertThat(planningRequest.getPath())
                .isEqualTo("/internal/v1/ia/conteudos/" + conteudoId + "/publicar-biblioteca");
        ...
        assertThat(planningRequest.getHeader("X-Correlation-Id")).isEqualTo("corr-planejamento-biblioteca-write-2");
        ...
        assertThat(planningRequest.getBody().readUtf8()).isEmpty();
    }
