...
class PlanningAiConteudoVersaoApproveProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanningAiServiceNaAprovacaoOficialDeVersaoConteudoIa() throws InterruptedException {
