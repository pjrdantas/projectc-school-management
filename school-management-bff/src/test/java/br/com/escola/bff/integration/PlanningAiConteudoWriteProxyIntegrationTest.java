...
class PlanningAiConteudoWriteProxyIntegrationTest {
    ...
    @Test
    void deveConsumirPlanningAiServiceNaGeracaoOficialDeConteudoPlanejamentoIa() throws InterruptedException {
