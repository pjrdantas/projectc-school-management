...
class DashboardIndicadorSnapshotReadProxyIntegrationTest {
    ...
    @Test
    void deveConsumirDashboardQueryServiceNaLeituraOficialDeSnapshots() throws InterruptedException {
        ...
        DASHBOARD_QUERY.enqueue(new MockResponse()
                ...
                .setBody("""
                        [{
                          ...
                          "publicoDashboardId":"00000000-0000-0000-0000-000000000201",
        ...
        MONOLITH.enqueue(new MockResponse()
                ...
                .setBody("""
                        [{
                          ...
                          "publicoDashboardId":"00000000-0000-0000-0000-000000000202",
                          "publicoCodigo":"DASH-SNAP-DIRETOR",
                          "escolaId":"00000000-0000-0000-0000-000000000047",
        ...
        MONOLITH.enqueue(new MockResponse()
                ...
                .setBody("""
                        [{
                          ...
                          "publicoDashboardId":"00000000-0000-0000-0000-000000000203",
                          "publicoCodigo":"DASH-SNAP-DIRETOR",
                          "escolaId":"00000000-0000-0000-0000-000000000047",
