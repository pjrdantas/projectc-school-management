...
class MonolithDisciplinaClientTest {
    ...
    void devePreservarContratoEPropagarSomenteHeadersConfiaveis() throws Exception {
        server.enqueue(new MockResponse()
                ...
                .setBody("""
                        ...
                        """));
        MonolithDisciplinaClient client = client(Duration.ofSeconds(2));
    ...
    void deveAplicarTimeoutControlado() {
        ...
        MonolithDisciplinaClient client = client(Duration.ofMillis(50));
    ...
    private MonolithDisciplinaClient client(Duration responseTimeout) {
        URI baseUrl = server.url("/").uri();
        MonolithClientProperties properties = new MonolithClientProperties(
                baseUrl, Duration.ofSeconds(1), responseTimeout);
        return new MonolithDisciplinaClient(
