...
public class JdbcMigracaoDestinoAdapter implements MigracaoDestinoPort {

    private final JdbcTemplate jdbc;

    public JdbcMigracaoDestinoAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
    ...
    public MigracaoSnapshot carregarSnapshot() {
        return JdbcSnapshotReader.read(jdbc, false);
    }
}
