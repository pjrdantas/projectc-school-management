package br.com.escola.catalog.infra.security;
...
public class InternalApiInterceptor implements HandlerInterceptor {
    ...
    public InternalApiInterceptor(@Value("${catalog.internal-api.token:}") String configuredToken) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        InternalRequestContext context = new InternalRequestContext(
                correlationId, usuarioId, new EscolaId(escolaId));
