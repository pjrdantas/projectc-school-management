...
public class CatalogMigrationDataSourceConfiguration {

    @Bean
    CatalogMigrationSourceConnection catalogMigrationSourceConnection(
        ...
        return new CatalogMigrationSourceConnection(jdbc, transaction);
    }
}
