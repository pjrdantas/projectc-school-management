...
final class JdbcCatalogSnapshotReader {

    private JdbcCatalogSnapshotReader() {}

    static CatalogMigrationSnapshot read(JdbcTemplate jdbc, boolean source) {
        var niveis = jdbc.query("""
                SELECT id_nivel_ensino, codigo, descricao
                  FROM nivel_ensino ORDER BY id_nivel_ensino
                """, (rs, row) -> new CatalogMigrationSnapshot.NivelEnsinoRow(
        ...
        var turnos = jdbc.query("""
                ...
                """, (rs, row) -> new CatalogMigrationSnapshot.TurnoRow(
        ...
        var periodos = jdbc.query("""
                ...
                """, (rs, row) -> new CatalogMigrationSnapshot.PeriodoLetivoRow(
        ...
        var series = jdbc.query("""
                ...
                """, (rs, row) -> new CatalogMigrationSnapshot.SerieRow(
        ...
        var disciplinas = jdbc.query("""
                ...
                """, (rs, row) -> new CatalogMigrationSnapshot.DisciplinaRow(
        ...
        var turmas = jdbc.query("""
                ...
                """, (rs, row) -> new CatalogMigrationSnapshot.TurmaRow(
        ...
        return new CatalogMigrationSnapshot(niveis, turnos, periodos, series, disciplinas, turmas, vinculos);
    }

    private static java.util.List<CatalogMigrationSnapshot.TurmaDisciplinaRow> readSourceLinks(JdbcTemplate jdbc) {
        return jdbc.query("""
            ...
            return new CatalogMigrationSnapshot.TurmaDisciplinaRow(
    ...
    private static java.util.List<CatalogMigrationSnapshot.TurmaDisciplinaRow> readTargetLinks(JdbcTemplate jdbc) {
        return jdbc.query("""
                ...
                """, (rs, row) -> new CatalogMigrationSnapshot.TurmaDisciplinaRow(
