...
class ConsultaServiceCacheTest {
    ...
    void setUp() {
        ...
        service = new ConsultaService(
                ...
                cachePort, new CacheSettings(true, Duration.ofMinutes(5)));
    }
    ...
    private LeituraSnapshot snapshot(List<DisciplinaResponse> disciplinas) {
