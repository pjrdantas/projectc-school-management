...
public class TransferenciaAlunoInternalController {

    private final TransferenciaAlunoService transferenciaAlunoService;

    public TransferenciaAlunoInternalController(TransferenciaAlunoService transferenciaAlunoService) {
    ...
    public List<TransferenciaAlunoResponse> listarPorAluno(@PathVariable @NonNull UUID alunoId) {
        return transferenciaAlunoService.listarPorAluno(alunoId).stream()
                .map(this::toResponse)
                .toList();
    }
