...
import br.com.escola.seguranca.adapter.in.web.dto.UsuarioRequest;
import br.com.escola.seguranca.adapter.in.web.dto.UsuarioResponse;
    ...
    private UsuarioResponse toDto(UsuarioModel m) {
        return new UsuarioResponse(
                ...
                m.getPerfis() != null
                        ...
                        : List.of(),
                m.getPerfis() != null
                        ? m.getPerfis().stream().map(PerfilModel::getCodigo).collect(Collectors.toSet())
                        : Set.of(),
                m.getPerfis() != null
