...
import br.com.escola.academiccatalog.adapter.out.persistence.repository.TurnoJpaRepository;
...
public class TurmaPersistenceGateway implements TurmaGateway {
    ...
    private br.com.escola.academiccatalog.adapter.out.persistence.entity.TurnoEntity resolveTurno(String codigo) {
