...
class ProfessorInternalClientHealthIndicatorTest {
    ...
    void deveReportarUpQuandoClienteInternoEstaDesabilitado() {
        ...
        assertThat(health.getDetails())
                ...
                .containsEntry("criarCutoverEnabled", false)
                .containsEntry("vincularTurmaDisciplinaCutoverEnabled", false)
    ...
    void deveReportarUpQuandoClienteInternoEstaHabilitadoComBaseUrlValidaEMetricas() {
        MockEnvironment environment = new MockEnvironment()
                ...
                .withProperty("professor.internal-client.criar-cutover-enabled", "true")
                .withProperty("professor.internal-client.vincular-turma-disciplina-cutover-enabled", "true")
