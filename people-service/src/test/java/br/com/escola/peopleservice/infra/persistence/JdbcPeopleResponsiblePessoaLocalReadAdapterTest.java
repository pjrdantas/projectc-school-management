...
class JdbcPeopleResponsiblePessoaLocalReadAdapterTest {
    ...
    void deveLerVinculoResponsavelPessoaPorResponsavelEEscola() throws Exception {
        ...
        JdbcPeopleResponsiblePessoaLocalReadAdapter adapter = new JdbcPeopleResponsiblePessoaLocalReadAdapter(
