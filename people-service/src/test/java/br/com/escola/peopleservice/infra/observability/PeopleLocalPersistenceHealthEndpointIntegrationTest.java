...
class PeopleLocalPersistenceHealthEndpointIntegrationTest {
    ...
    void deveExporHealthDedicadoDaFundacaoLocalDesligada() {
        ...
        Map<String, Object> contactScopeClosure =
                (Map<String, Object>) details.get("peopleContactScopeClosureDiagnostic");
        ...
        Map<String, Object> professorScopeDiagnostic =
                (Map<String, Object>) details.get("peopleProfessorScopeDiagnostic");
        ...
        Map<String, Object> professorInternalSummaryContract =
                (Map<String, Object>) details.get("peopleProfessorInternalSummaryContractDiagnostic");
        ...
        Map<String, Object> professorAdapterPreparation =
                (Map<String, Object>) details.get("peopleProfessorInternalSummaryAdapterPreparationDiagnostic");
