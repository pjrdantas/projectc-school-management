...
import br.com.escola.peopleservice.infra.config.LeituraModeloSourceProperties;
import br.com.escola.peopleservice.infra.config.LeituraModeloMigrationProperties;

class JdbcCatalogoReadModelSyncAdapterTest {

    @Test
    void bloqueiaSincronizacaoQuandoOrigemOuDestinoNaoEstaoConfigurados() {
        JdbcCatalogoReadModelSyncAdapter adapter = new JdbcCatalogoReadModelSyncAdapter(
                new LeituraModeloSourceProperties("", "", "", ""),
    ...
    void copiaEReconciliaCatalogosEIdentidadeDoMonolitoParaSchemaLocal() throws Exception {
        ...
        JdbcCatalogoReadModelSyncAdapter adapter = new JdbcCatalogoReadModelSyncAdapter(
                new LeituraModeloSourceProperties(sourceUrl, "sa", "", "org.h2.Driver"),
                new LeituraModeloMigrationProperties(targetUrl, "sa", "", "org.h2.Driver", List.of()));
