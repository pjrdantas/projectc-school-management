...
import br.com.escola.peopleservice.application.port.out.PeopleStudentPessoaLocalReadPort;
import io.micrometer.core.instrument.simple.SimpleMeterRegistry;

class PeopleStudentPessoaLocalReadServiceTest {

    @Test
    void retornaVazioQuandoAdapterNaoExiste() {
        SimpleMeterRegistry meterRegistry = new SimpleMeterRegistry();
        PeopleStudentPessoaLocalReadService service = new PeopleStudentPessoaLocalReadService(
                provider(null),
                meterRegistry);
        ...
        assertThat(meterRegistry.counter(
                "people.shadow.local.persistence.student.pessoa.lookup",
    ...
    private ObjectProvider<PeopleStudentPessoaLocalReadPort> provider(PeopleStudentPessoaLocalReadPort port) {
        return new ObjectProvider<>() {
            @Override
            public PeopleStudentPessoaLocalReadPort getObject(Object... args) {
                return port;
            }

            @Override
            public PeopleStudentPessoaLocalReadPort getIfAvailable() {
                return port;
            }

            @Override
            public PeopleStudentPessoaLocalReadPort getIfUnique() {
                return port;
            }

            @Override
            public PeopleStudentPessoaLocalReadPort getObject() {
                return port;
            }
        };
    }

    private static class CountingPort implements PeopleStudentPessoaLocalReadPort {
    ...
    private static class FailingPort implements PeopleStudentPessoaLocalReadPort {
