...
class PeopleLocalPersistenceHealthIndicatorTest {
    ...
    void deveReportarUpQuandoCutoverLocalEstaHabilitadoComBackfillVerde() {
        ...
        Map<String, Object> studentResponsibleScopeDiagnostic =
                (Map<String, Object>) health.getDetails().get("peopleStudentResponsibleLinkScopeDiagnostic");
        ...
        Map<String, Object> studentResponsibleScopeClosure =
                (Map<String, Object>) health.getDetails().get("peopleStudentResponsibleLinkScopeClosureDiagnostic");
