...
@Component
public class JdbcPeopleResponsiblePessoaLocalReadAdapter implements PeopleResponsiblePessoaLocalReadPort {
    ...
    public JdbcPeopleResponsiblePessoaLocalReadAdapter(PeopleLocalReadModelSchemaMigrationProperties properties) {
