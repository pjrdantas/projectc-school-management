...
public class PeopleTransactionalReadModelExpansionPlanner {
    ...
    public PeopleTransactionalReadModelExpansionPlan planejarProximaFatiaTransacional() {
        return new PeopleTransactionalReadModelExpansionPlan(
                "address_local_read_cutover_eligibility_diagnostic_started",
                "define_address_read_cutover_guard_criteria_no_route_change",
                "address_read_cutover_eligibility_diagnostic_no_connection",
                true,
                true,
                false,
                List.of(
                        ...
                        new TableExpansionDecision(
                                ...
                                List.of("addressLocalReadCutoverEligibility"),
                                false,
                                true,
                                true,
                                false,
