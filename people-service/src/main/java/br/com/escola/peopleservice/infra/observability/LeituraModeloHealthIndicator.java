...
import br.com.escola.peopleservice.application.service.OrigemLeituraDecision;
...
public class LeituraModeloHealthIndicator implements HealthIndicator {
    ...
    private final LeituraModeloMigrationState schemaMigrationState;
    ...
    public LeituraModeloHealthIndicator(
            ...
            LeituraModeloMigrationState schemaMigrationState,
    ...
    public Health health() {
        ...
        details.put("studentReadRoutingDecisionsTotal",
                totalContador("people.student.read.routing.decisions"));
        details.put("localStudentLookupsTotal",
                totalContador("people.student.lookup"));
    ...
    private Map<String, Object> mapDecisions(Map<String, OrigemLeituraDecision> decisions) {
        Map<String, Object> details = new LinkedHashMap<>();
    ...
    private Map<String, Object> mapDecision(OrigemLeituraDecision decision) {
        Map<String, Object> details = new LinkedHashMap<>();
    ...
    private String primeiraRestricaoDeRoteamento() {
        return readRoutingPolicy.avaliarTodas().values().stream()
                .map(OrigemLeituraDecision::reason)
