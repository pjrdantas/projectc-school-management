...
@Component
public class JdbcPeopleCatalogLocalReadAdapter implements PeopleCatalogLocalReadPort {

    private final PeopleLocalReadModelSchemaMigrationProperties properties;

    public JdbcPeopleCatalogLocalReadAdapter(PeopleLocalReadModelSchemaMigrationProperties properties) {
