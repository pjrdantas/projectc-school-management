...
@Component
public class JdbcPeopleIdentityLocalReadAdapter implements PeopleIdentityLocalReadPort {
    ...
    public JdbcPeopleIdentityLocalReadAdapter(PeopleLocalReadModelSchemaMigrationProperties properties) {
