...
public class PeopleLocalPersistenceHealthIndicator implements HealthIndicator {
    ...
    public Health health() {
        ...
        details.put("peopleFuncionarioInternalSummaryBackfillReconciliationDiagnostic",
    ...
    private Map<String, Object> diagnosticoAutoridadeEscritaEndereco() {
        return addressDiagnostics.diagnosticoAutoridadeEscritaEndereco();
    }

    private Map<String, Object> diagnosticoAdapterEscritaMonolito() {
        return addressDiagnostics.diagnosticoAdapterEscritaMonolito();
    }

    private Map<String, Object> diagnosticoFechamentoEscopoPessoaEndereco() {
        return addressDiagnostics.diagnosticoFechamentoEscopoPessoaEndereco();
    }

    private Map<String, Object> diagnosticoEscopoPessoaDocumento() {
        return documentDiagnostics.diagnosticoEscopoPessoaDocumento();
    }

    private Map<String, Object> diagnosticoContratoInternoLeituraMetadadosDocumento() {
        return documentDiagnostics.diagnosticoContratoInternoLeituraMetadadosDocumento();
    }

    private Map<String, Object> diagnosticoCandidatoLeituraLocalDocumento() {
        return documentDiagnostics.diagnosticoCandidatoLeituraLocalDocumento();
    }

    private Map<String, Object> diagnosticoSchemaMetadadosDocumento() {
        return documentDiagnostics.diagnosticoSchemaMetadadosDocumento();
    }

    private Map<String, Object> diagnosticoPreparacaoAdapterLocalMetadadosDocumento() {
        return documentDiagnostics.diagnosticoPreparacaoAdapterLocalMetadadosDocumento();
    }

    private Map<String, Object> diagnosticoBackfillReconciliacaoDocumento() {
        return documentDiagnostics.diagnosticoBackfillReconciliacaoDocumento();
    }

    private Map<String, Object> diagnosticoElegibilidadeAtivacaoLeituraLocalDocumento() {
        return documentDiagnostics.diagnosticoElegibilidadeAtivacaoLeituraLocalDocumento();
    }

    private Map<String, Object> diagnosticoUsoInternoMinimoDocumento() {
        return documentDiagnostics.diagnosticoUsoInternoMinimoDocumento();
    }

    private Map<String, Object> diagnosticoFechamentoEscopoPessoaDocumento() {
        return documentDiagnostics.diagnosticoFechamentoEscopoPessoaDocumento();
    }

    private Map<String, Object> diagnosticoContratoConsumidorAlunoDocumento() {
        return documentDiagnostics.diagnosticoContratoConsumidorAlunoDocumento();
    }

    private Map<String, Object> diagnosticoEstrategiaConexaoConsumidorAlunoDocumento() {
        return documentDiagnostics.diagnosticoEstrategiaConexaoConsumidorAlunoDocumento();
    }

    private Map<String, Object> diagnosticoContratoConsumidorResponsavelDocumento() {
        return documentDiagnostics.diagnosticoContratoConsumidorResponsavelDocumento();
    }

    private Map<String, Object> diagnosticoEstrategiaConexaoConsumidorResponsavelDocumento() {
        return documentDiagnostics.diagnosticoEstrategiaConexaoConsumidorResponsavelDocumento();
    }

    private Map<String, Object> diagnosticoEscopoFuncionario() {
        return funcionarioDiagnostics.diagnosticoEscopoFuncionario();
    }

    private Map<String, Object> diagnosticoContratoInternoResumoFuncionario() {
        return funcionarioDiagnostics.diagnosticoContratoInternoResumoFuncionario();
    }

    private Map<String, Object> diagnosticoPreparacaoAdapterResumoFuncionario() {
        return funcionarioDiagnostics.diagnosticoPreparacaoAdapterResumoFuncionario();
    }

    private Map<String, Object> diagnosticoBackfillReconciliacaoResumoFuncionario() {
        return funcionarioDiagnostics.diagnosticoBackfillReconciliacaoResumoFuncionario();
    }

    private Map<String, Object> diagnosticoElegibilidadeAtivacaoLeituraLocalResumoFuncionario() {
        return funcionarioDiagnostics.diagnosticoElegibilidadeAtivacaoLeituraLocalResumoFuncionario();
    }

    private Map<String, Object> diagnosticoUsoInternoMinimoResumoFuncionario() {
        return funcionarioDiagnostics.diagnosticoUsoInternoMinimoResumoFuncionario();
    }
