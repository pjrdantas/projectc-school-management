...
@Component
public class JdbcPeopleStudentPessoaLocalReadAdapter implements PeopleStudentPessoaLocalReadPort {
    ...
    public JdbcPeopleStudentPessoaLocalReadAdapter(PeopleLocalReadModelSchemaMigrationProperties properties) {
