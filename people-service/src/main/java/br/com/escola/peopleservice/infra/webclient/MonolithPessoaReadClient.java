...
@Component
public class MonolithPessoaReadClient implements PessoaReadPort {
    ...
    public MonolithPessoaReadClient(RestClient monolithPeopleRestClient, MeterRegistry meterRegistry) {
