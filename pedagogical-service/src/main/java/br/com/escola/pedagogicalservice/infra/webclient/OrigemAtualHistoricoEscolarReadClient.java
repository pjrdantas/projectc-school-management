...
@Component
public class OrigemAtualHistoricoEscolarReadClient implements HistoricoEscolarReadPort {

    private final RestClient restClient;
    private final MeterRegistry meterRegistry;

    public OrigemAtualHistoricoEscolarReadClient(RestClient monolithPedagogicalRestClient, MeterRegistry meterRegistry) {
    ...
    public HistoricoEscolarTelaResponse carregarNovo(
        ...
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new RecursoNaoEncontradoException("Carregamento de historico escolar nao encontrado");
            }
        ...
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                meterRegistry.counter("pedagogical.monolith.requests", "route", "historicoCarregamento", "result", "not_found")
                        .increment();
                throw new RecursoNaoEncontradoException("Historico escolar nao encontrado para carregamento");
            }
