...
@Component
public class MonolithAulaClient implements AulaPort {

    private final RestClient restClient;
    private final MeterRegistry meterRegistry;

    public MonolithAulaClient(RestClient monolithPedagogicalRestClient, MeterRegistry meterRegistry) {
    ...
    public AulaResponse criar(String authorization, InternalRequestContext context, String requestBody) {
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new PedagogicalServiceResourceNotFoundException("Dependencia de aula nao encontrada");
            }
    ...
    public List<AulaResponse> listar(
        ...
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new PedagogicalServiceResourceNotFoundException("Consulta de aulas nao encontrada");
            }
    ...
    public AulaResponse buscarPorId(String authorization, InternalRequestContext context, UUID aulaId) {
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new PedagogicalServiceResourceNotFoundException("Aula nao encontrada");
            }
