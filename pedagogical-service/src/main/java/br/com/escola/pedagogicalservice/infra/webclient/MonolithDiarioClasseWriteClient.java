...
@Component
public class MonolithDiarioClasseWriteClient implements DiarioClasseWritePort {

    private final RestClient restClient;
    private final MeterRegistry meterRegistry;

    public MonolithDiarioClasseWriteClient(RestClient monolithPedagogicalRestClient, MeterRegistry meterRegistry) {
    ...
    public ResponseEntity<String> salvar(
        ...
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new PedagogicalServiceResourceNotFoundException("Diario de classe nao encontrado para salvamento");
            }
