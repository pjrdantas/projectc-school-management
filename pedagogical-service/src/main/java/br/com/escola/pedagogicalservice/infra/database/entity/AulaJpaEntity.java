...
@Entity
@Table(name = "class_lesson_record")
public class AulaJpaEntity {
    ...
    protected AulaJpaEntity() {
    }

    public AulaJpaEntity(UUID id, UUID schoolId, UUID professorTurmaDisciplinaId, UUID turmaId, String payloadJson, LocalDateTime createdAt) {
        this.id = id;
