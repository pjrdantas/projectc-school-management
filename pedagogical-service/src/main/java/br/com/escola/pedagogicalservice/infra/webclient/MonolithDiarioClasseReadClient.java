...
@Component
public class MonolithDiarioClasseReadClient implements DiarioClasseReadPort {

    private final RestClient restClient;
    private final MeterRegistry meterRegistry;

    public MonolithDiarioClasseReadClient(RestClient monolithPedagogicalRestClient, MeterRegistry meterRegistry) {
    ...
    public ResponseEntity<String> carregar(
        ...
        try {
            ...
            if (exception.getStatusCode().value() == 404) {
                ...
                throw new PedagogicalServiceResourceNotFoundException("Diario de classe nao encontrado");
            }
