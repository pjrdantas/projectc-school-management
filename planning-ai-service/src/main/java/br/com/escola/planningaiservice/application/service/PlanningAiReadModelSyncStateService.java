...
@Service
public class PlanningAiReadModelSyncStateService {
    ...
    public PlanningAiReadModelSyncStateService(PlanningAiReadModelSyncStateJpaRepository repository) {
    ...
    private void save(String scope, UUID escolaId, UUID referenciaId, String queryKey) {
        ...
        PlanningAiReadModelSyncStateJpaEntity state = repository.findById(id)
                .orElseGet(PlanningAiReadModelSyncStateJpaEntity::new);
        state.setId(id);
