package br.com.escola.planningaiservice.interfaces.advice;
...
import br.com.escola.planningaiservice.application.exception.InternalApiUnauthorizedException;
import br.com.escola.planningaiservice.application.exception.InvalidRequestContextException;
import br.com.escola.planningaiservice.application.exception.PlanningAiServiceResourceNotFoundException;
import br.com.escola.planningaiservice.interfaces.response.ApiErrorResponse;
import jakarta.servlet.http.HttpServletRequest;

@RestControllerAdvice
public class PlanningAiServiceApiExceptionHandler {
    ...
    @ExceptionHandler(PlanningAiServiceResourceNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handleNotFound(
            PlanningAiServiceResourceNotFoundException exception,
            HttpServletRequest request) {
