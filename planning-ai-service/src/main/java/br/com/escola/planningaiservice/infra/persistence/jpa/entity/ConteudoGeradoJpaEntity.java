...
public class ConteudoGeradoJpaEntity {
    ...
    private InteracaoJpaEntity interacao;
    ...
    public InteracaoJpaEntity getInteracao() {
        return interacao;
    }

    public void setInteracao(InteracaoJpaEntity interacao) {
