...
@Service
public class LeituraModeloSyncService {
    ...
    public LeituraModeloSyncService(
    ...
    private InteracaoJpaEntity upsertInteraction(
        ...
        InteracaoJpaEntity interaction = interactionRepository.findById(response.id())
    ...
    private ConteudoGeradoJpaEntity upsertContent(
            InternalRequestContext context,
            ConteudoIaResponse response) {
    ...
    private void upsertVersion(
        ...
        ConteudoGeradoJpaEntity content = contentRepository.findByIdAndEscolaId(
    ...
    private void upsertLibraryEntry(
        ...
        BibliotecaConteudoJpaEntity library = libraryRepository.findById(response.id())
    ...
    private InteracaoJpaEntity resolveInteraction(java.util.UUID interactionId) {
