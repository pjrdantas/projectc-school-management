package br.com.escola.responsiblesservice.infra.security;
...
import br.com.escola.responsiblesservice.application.exception.InternalApiUnauthorizedException;
import br.com.escola.responsiblesservice.application.exception.InvalidRequestContextException;
...
public class InternalApiInterceptor implements HandlerInterceptor {
    ...
    public InternalApiInterceptor(@Value("${responsibles.internal-api.token:}") String configuredToken) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        request.setAttribute(
                InternalHeaders.REQUEST_CONTEXT_ATTRIBUTE,
                new InternalRequestContext(correlationId, usuarioId, escolaId));
