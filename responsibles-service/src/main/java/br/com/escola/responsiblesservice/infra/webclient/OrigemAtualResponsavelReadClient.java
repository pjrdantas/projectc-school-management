...
@Component
public class OrigemAtualResponsavelReadClient implements ResponsavelReadPort {

    private final RestClient restClient;

    public OrigemAtualResponsavelReadClient(RestClient responsiblesMonolithRestClient) {
    ...
    public ResponseEntity<String> listarResponsaveis(
            ...
            String nome,
            String cpf) {
        return withHeaders(restClient.get()
                        .uri(uriBuilder -> {
