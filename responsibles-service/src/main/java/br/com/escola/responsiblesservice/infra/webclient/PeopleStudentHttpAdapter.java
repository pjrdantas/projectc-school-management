...
import br.com.escola.responsiblesservice.infra.config.PeopleStudentClientProperties;

@Component
public class PeopleStudentHttpAdapter implements AlunoConsultaPort {

    private final RestClient restClient;
    private final PeopleStudentClientProperties properties;

    public PeopleStudentHttpAdapter(
            @Qualifier("peopleStudentRestClient") RestClient restClient,
            PeopleStudentClientProperties properties) {
