...
public class DashboardIndicadorHistoricoInternalController {

    private final DashboardIndicadorHistoricoUseCase dashboardIndicadorHistoricoUseCase;

    public DashboardIndicadorHistoricoInternalController(DashboardIndicadorHistoricoUseCase dashboardIndicadorHistoricoUseCase) {
