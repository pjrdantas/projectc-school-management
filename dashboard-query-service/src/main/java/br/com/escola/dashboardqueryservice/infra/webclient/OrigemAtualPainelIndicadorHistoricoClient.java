...
@Component
public class OrigemAtualPainelIndicadorHistoricoClient implements PainelIndicadorHistoricoPort {

    private final RestClient restClient;

    public OrigemAtualPainelIndicadorHistoricoClient(RestClient dashboardQueryMonolithRestClient) {
    ...
    public List<PainelIndicadorHistoricoResponse> consultarHistorico(
            ...
            UUID professorId) {
        try {
            List<PainelIndicadorHistoricoResponse> response = restClient.get()
                    .uri(uriBuilder -> {
                    ...
                    .retrieve()
                    .body(new ParameterizedTypeReference<List<PainelIndicadorHistoricoResponse>>() {
                    });
