...
@Component
public class MonolithDashboardPublicoClient implements DashboardPublicoPort {

    private final RestClient restClient;

    public MonolithDashboardPublicoClient(RestClient dashboardQueryMonolithRestClient) {
    ...
    public List<DashboardPublicoResponse> listarPublicos(
        ...
        try {
            List<DashboardPublicoResponse> response = restClient.get()
                    ...
                    .retrieve()
                    .body(new ParameterizedTypeReference<List<DashboardPublicoResponse>>() {
                    });
