...
@Component
public class OrigemAtualPainelIndicadorSnapshotClient implements PainelIndicadorSnapshotPort {

    private final RestClient restClient;

    public OrigemAtualPainelIndicadorSnapshotClient(RestClient dashboardQueryMonolithRestClient) {
    ...
    public List<PainelIndicadorSnapshotResponse> listarPorPublicoCodigo(
        ...
        try {
            List<PainelIndicadorSnapshotResponse> response = restClient.get()
                    .uri(uriBuilder -> {
                    ...
                    .retrieve()
                    .body(new ParameterizedTypeReference<List<PainelIndicadorSnapshotResponse>>() {
                    });
