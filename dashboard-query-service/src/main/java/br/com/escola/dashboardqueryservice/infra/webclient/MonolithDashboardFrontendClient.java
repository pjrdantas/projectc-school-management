...
@Component
public class MonolithDashboardFrontendClient implements DashboardFrontendPort {

    private final RestClient restClient;

    public MonolithDashboardFrontendClient(RestClient dashboardQueryMonolithRestClient) {
    ...
    public DashboardFrontendResponse consultar(
        ...
        try {
            return restClient.get()
                    ...
                    .retrieve()
                    .body(DashboardFrontendResponse.class);
