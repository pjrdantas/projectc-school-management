package br.com.escola.dashboardqueryservice.infra.security;
...
public class InternalApiInterceptor implements HandlerInterceptor {
    ...
    public InternalApiInterceptor(@Value("${dashboard-query.internal-api.token:}") String configuredToken) {
