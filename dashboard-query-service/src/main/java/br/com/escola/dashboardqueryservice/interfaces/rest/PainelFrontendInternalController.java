...
public class PainelFrontendInternalController {

    private final PainelFrontendUseCase dashboardFrontendUseCase;

    public PainelFrontendInternalController(PainelFrontendUseCase dashboardFrontendUseCase) {
