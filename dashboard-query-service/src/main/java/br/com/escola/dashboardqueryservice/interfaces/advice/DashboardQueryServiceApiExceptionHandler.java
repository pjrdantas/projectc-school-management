...
public class DashboardQueryServiceApiExceptionHandler {
    ...
    @ExceptionHandler(DashboardQueryServiceResourceNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handleNotFound(
            DashboardQueryServiceResourceNotFoundException exception,
            HttpServletRequest request) {
