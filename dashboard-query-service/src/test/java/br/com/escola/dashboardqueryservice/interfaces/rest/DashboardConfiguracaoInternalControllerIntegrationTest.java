...
class DashboardConfiguracaoInternalControllerIntegrationTest {
    ...
    @Test
    void deveConsultarDashboardsNoContratoInterno() throws Exception {
        ...
        mockMvc.perform(get("/internal/v1/dashboard/configuracoes/dashboards")
                ...
                .andExpect(jsonPath("$[0].nome").value("Dashboard Diretor Teste"));
    ...
    @Test
    void deveExigirTokenInternoValidoNaConsultaDeDashboards() throws Exception {
        mockMvc.perform(get("/internal/v1/dashboard/configuracoes/dashboards")
                        .header("Authorization", "Bearer internal-token")
