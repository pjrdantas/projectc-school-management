...
class DashboardSecretariaInternalControllerIntegrationTest {
    ...
    @Test
    void deveConsultarDashboardSecretariaNoContratoInterno() throws Exception {
                ...
                .setBody("""
                        {
                          ...
                          "turmasComVagas":[{"turmaId":"00000000-0000-0000-0000-000000000302","turmaNome":"Turma Secretaria","capacidade":30,"vagasOcupadas":20,"vagasDisponiveis":10}]
                        }
                        """));
        ...
        mockMvc.perform(get("/internal/v1/dashboard/secretaria")
                        .header("X-Internal-Token", "dashboard-token")
                        .header("X-Correlation-Id", "corr-dashboard-sec-1")
                ...
                .andExpect(jsonPath("$.matriculasEmAndamento").value(2))
                .andExpect(jsonPath("$.transferencias").value(9))
                .andExpect(jsonPath("$.matriculasPorStatus[0].status").value("EM_ANDAMENTO"));

        RecordedRequest recorded = aguardarRequisicao("/api/dashboard/secretaria");
        assertThat(recorded.getHeader("Authorization")).isEqualTo("Bearer dashboard-token");
        assertThat(recorded.getHeader("X-Correlation-Id")).isEqualTo("corr-dashboard-sec-1");
    ...
    void deveExigirTokenInternoValido() throws Exception {
        mockMvc.perform(get("/internal/v1/dashboard/secretaria")
                        .header("X-Correlation-Id", "corr-dashboard-sec-2")
