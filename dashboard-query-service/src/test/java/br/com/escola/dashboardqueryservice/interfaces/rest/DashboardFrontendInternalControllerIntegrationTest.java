...
class DashboardFrontendInternalControllerIntegrationTest {
    ...
    @Test
    void deveConsultarDashboardFrontendNoContratoInterno() throws Exception {
    ...
    @Test
    void deveExigirTokenInternoValidoNaConsultaDeDashboardFrontend() throws Exception {
        mockMvc.perform(get("/internal/v1/dashboard/frontend")
                        .header("Authorization", "Bearer internal-token")
